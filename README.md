...
This app is ready to start. It's powered by [Vike](https://vike.dev) and [React](https://react.dev/learn), [telefunc](https://telefunc.com/), [express](https://expressjs.com/)
